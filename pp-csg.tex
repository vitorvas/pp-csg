...
my C++ and, I might be wrong here, but I think it is more straightful to use a C++ test tool. In the presente case, I'm starting
...
implementation is not a CSG library, no need to provide the same operations of a truly CSG implementation. The ideia is to
